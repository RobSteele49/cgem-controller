...
# computer.
#
# On 2024-12-30 This code connected to COM6. The output was:
# python testSerialWinChrome.py
# Open the serial port, with port COM6
# Serial info: Serial<id=0x2c548b8cd30, open=True>(port='COM6', baudrate=9600, bytesize=8, parity='N', stopbits=1, timeout=None, xonxoff=False, rtscts=False, dsrdtr=False)
# Print the current timeout and then set it for 2.0
# Serial timeout: None
# Connectd to port: COM6
# Serial timeout: 2.0
# Serial read has timed out
# About to try and close the serial port
