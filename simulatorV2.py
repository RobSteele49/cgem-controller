...
# 2025-01-01 Will try and move from using serial code directly in this
# program just use the import serial and pass on the serial.serialposix
# for now.
...
if __name__ == '__main__':
  ...
  while not done:
    if ser.isOpen() == False:
      ...
      print ('Will attemt a read operation')
      cmd = ser.read(1)
      if cmd != '':
